      ...
      <ul class="nav sidebar-nav" style="list-style-type: none;">
        <div class="sidebar-header">
          <div class="sidebar-brand">
            <a href="#">Oussama Aarab</a>
          </div>
        </div>
        <li><a href="#home">Module</a></li>
        <li><a href="#about">Profile</a></li>
        <li><a href="#events">Calendrier</a></li>
        <li><a href="#team">To Do</a></li>

        </li>
      </ul>
      <a class="navbar-brand" href=""><img src="/inc/images/logo.png" alt="ENSIAS-DOC" width="200" style="position: absolute;bottom: 100px;"></a>
    </nav>
    <!-- /#sidebar-wrapper -->
